...
#### 2.1.4 Cambio de Estructura (MSS) y BOS
Market structure via 5-bar fractal swings...
#### 2.1.5 Analisis de Volumen (HVN/LVN)
...
### 2.3 Aprendizaje Automatico Supervisado
#### 2.3.1 Seleccion del Algoritmo
...
#### 2.3.3 Validacion Fuera de Muestra (OOS)
...
### 4.3 Smart TP y Red de Seguridad SL
...
### 5.3 Importancia de Caracteristicas
...
## 8. Analisis de Caracteristicas
### 8.1 Las Caracteristicas ICT son Ruido
...
## 9. Anomalias del Mercado
### 9.1 Paradoja DXY-EURUSD
...
## 10. Riesgo de Noticias
### 10.1 Arquitectura del Scraper
