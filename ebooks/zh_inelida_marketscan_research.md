...
**License:** MIT. 关键词: 算法交易, ICT, Ichimoku, XGBoost, ML, DXY

## Abstract / Resume

本文档介绍了InelidaMarketScan项目的研究成果。This document presents the research findings of the InelidaMarketScan project, an algorithmic trading system integrating ICT concepts, multi-timeframe Ichimoku analysis, and supervised ML (XGBoost). D
