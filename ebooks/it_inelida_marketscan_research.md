...
Questo documento presenta los resultados de investigacion del proyecto InelidaMarketScan. Los hallazgos principales: le caratteristiche ICT no tienen poder predictivo adicional (is_dxy, rr, tkx_h1 son le 3 migliori con ganancias 14.2, 10.0, 9.2); la especializacion por activo mejora el PF OOS en 340%; i mercoledi FOMC son la caracteristica #6 (ganancia 6.4). DXY: 73% WR (233 operaciones). Simulacion 10k EUR: PF 2.27, +25842 EUR.
