...
Este documento apresenta los resultados de investigacion del proyecto InelidaMarketScan. Los hallazgos principales: as caracteristicas ICT no tienen poder predictivo adicional (is_dxy, rr, tkx_h1 son las 3 mejores con ganancias 14.2, 10.0, 9.2); la especializacion por activo mejora el PF OOS en 340%; as quartas-feiras FOMC son la caracteristica #6 (ganancia 6.4). DXY: 73% WR (233 operaciones). Simulacion 10k EUR: PF 2.27, +25842 EUR.
