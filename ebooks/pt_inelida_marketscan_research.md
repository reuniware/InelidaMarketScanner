========================================================================
    ...
    INELIDAMARKETSCAN
    UMA ABORDAGEM CIENTIFICA AO TRADING ALGORITMICO
...
**License:** MIT. Palavras-chave: Trading algoritmico, ICT, Ichimoku, XGBoost, ML, DXY
...
### 2.3 Aprendizado de Maquina Supervisionado
#### 2.3.1 Selecao do Algoritmo
...
#### 2.3.3 Validacao Fora da Amostra (OOS)
...
### 4.3 Smart TP e Rede de Seguranca SL
...
### 5.3 Importancia das Caracteristicas
...
## 8. Analise de Caracteristicas
### 8.1 Caracteristicas ICT sao Ruido
...
## 9. Anomalias de Mercado
### 9.1 Paradoxo DXY-EURUSD
...
## 10. Risco de Noticias
### 10.1 Arquitetura do Scraper
...
"O mercado nao recompensa a complexidade, mas a simplicidade estatisticamente validada."
